...
description: Export Azure resources to Infrastructure as Code templates via Azure Resource Graph analysis, Azure Resource Manager API calls, and handoff to azure-iac-generator
license: Complete terms in LICENSE.txt
metadata:
  author: Koumudi Kaluvakolanu (skaluvak@microsoft.com)
...
- Include storage account dataplane configurations when relevant
